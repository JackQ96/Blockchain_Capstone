...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, 'Caller does not own the contract');
    _;
    }
...
contract Pausable is Ownable {
    ...
    function setPaused(bool condition) public onlyOwner{
        _paused = condition;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, 'Address is the same as tokenId owner');
        require(tokenOwner == msg.sender || isApprovedForAll(tokenOwner, msg.sender), 'Not authorised');
